...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="tautomatica.css" />
  ...
  <body>
    ...
    <div id="traductores">
      ...
      <br />
      <div id="googleH" style="display: none">
      ...
      <div id="deeplH" style="display: none">
      ...
      /></a>
      <div id="ponsH" style="display: none">
    ...
    <div class="dicc" style="display: none">
      <form
        id="formulario"
        class="formulario"
    ...
    <br />
    <div>
      <img src="../img/imagen.rodando.png" width="90" height="90" class="trueda" />
